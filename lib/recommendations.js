...
function isMonitorProduct(product) {
  ...
  const monitorSignals = [
    ...
    /\bhdmi\b.*\bmonitor\b/,
    /\bvga\b.*\bmonitor\b/,
    /\b(21|22|23|24|25|27|28|29|30|32|34)(("|”|'')|\s?inch|\s?in|\s?cm)?\b/
  ];
...
export function needsClarification(text) {
  ...
  const missingUse =
    !/(gaming|design|cad|office|work|home|wifi|student|streaming|accessor|cable|hub|adapter|adaptor|bag|monitor|screen|display|desktop|laptop)/i.test(text);
