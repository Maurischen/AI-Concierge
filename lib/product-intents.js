const PRODUCT_INTENTS = [
  ...
  {
    id: "network-switch",
    request: [/\bnetwork switch\b/i, /\bethernet switch\b/i, /\blan switch\b/i, /\bpoe switch\b/i, /\bswitch\b/i],
    category: [/\bswitches?\b/i, /\bnetwork(ing)?\s*>\s*switches?\b/i, /\bpoe\s*switches?\b/i],
    include: [
      /\bnetwork switch\b/i,
      /\bethernet switch\b/i,
      /\blan switch\b/i,
      /\bpoe switch\b/i,
      /\bgigabit switch\b/i,
      /\b10\/100\b/i,
    ...
    exclude: [
      ...
      /\bcctv\b/i,
      /\bsurveillance\b/i,
      /\bsecurity camera\b/i,
      /\bmedia converter\b/i
    ]
  },
  {
    id: "hub",
  ...
  },
  {
    ...
    exclude: [/\bmotherboard\b/i, /\blaptop\b/i, /\bnotebook\b/i, /\bdesktop pc\b/i, /\ball-in-one\b/i, /\baio\b/i]
  },
  {
    id: "psu",
